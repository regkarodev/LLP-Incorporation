...
def handle_file_uploads(driver, config_data):
    ...
    file3_path = os.path.abspath(config_data["form_data"]["file_paths"]["fifth_file"])
    file4_path = os.path.abspath(config_data["form_data"]["file_paths"]["sixth_file"])
    

    if not os.path.exists(file3_path):
        print(f"Warning: File {file3_path} does not exist!")
        raise Exception(f"First file not found: {file3_path}")
    if not os.path.exists(file4_path):
        print(f"Warning: File {file4_path} does not exist!")
        raise Exception(f"Second file not found: {file4_path}")
    ...
    # 10(b) Optional attachment(s) (if any)
    upload_optinal_file(driver, file3_path)

    # 10(c) Subscribers' sheet including consent.
    upload_file(driver, file4_path)



# 10(b) Optional attachment(s) (if any)
def upload_optinal_file(driver, file_path):
...
def upload_file(driver, file_path):
    ...
    try:
        ...
        exact_xpath = "/html/body/div[2]/div/div/div/div/div/form/div[4]/div/div[2]/div/div/div[1]/div/div[6]/div/div/div/div[1]/div/div[8]/div/div/div/div[1]/div/div[2]/div/div/div/div[1]/div/div[2]/div/div/div/div[1]/div/div[9]/div/div/div[2]/div[1]/button"
