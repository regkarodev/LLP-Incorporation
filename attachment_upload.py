...
def handle_file_uploads(driver, config_data):
    ...
    # file5_path = os.path.abspath(config_data["form_data"]["file_paths"]["seventh_file"])
    ...
    #     print(f"Warning: File {file5_path} does not exist!")
    #     raise Exception(f"First file not found: {file5_path}")
    ...
    # 10(a) Valuation Certificate
    upload_file(driver, file3_path)
